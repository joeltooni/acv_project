...
export BLENDER_PATH="/home/roboticslab/blender-3.3.1"
...
blenderproc run render_custom_templates.py --custom-blender-path $BLENDER_PATH --output_dir $OUTPUT_DIR --cad_path $CAD_PATH #--colorize True
